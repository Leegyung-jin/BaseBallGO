...
import com.bbgo.service.stadiumService.BearsService;
...
//    private final BearsService bearsService;
    ...
    public String list(PageRequestDTO pageRequestDTO, Model model) {
        model.addAttribute("result", bearsService.getList(pageRequestDTO));
        return "bears/list";
    }

    @GetMapping("/register")
    public String registerStadium(Model model) {
        return "bears/register";
    }
    ...
    public String register(StadiumDTO stadiumDTO, RedirectAttributes redirectAttributes) {
        ...
        Long sno = bearsService.register(stadiumDTO);
    ...
    public void read(long sno, @ModelAttribute("requestDTO") PageRequestDTO requestDTO, Model model) {
        StadiumDTO stadiumDTO = bearsService.getStadium(sno);
