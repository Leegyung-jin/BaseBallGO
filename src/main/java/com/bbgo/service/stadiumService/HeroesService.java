...
public interface HeroesService {
    ...
    PageResultDTO<StadiumDTO, HeroesStadium> getList(PageRequestDTO requestDTO);
    ...
    // List
    default StadiumDTO entityToDTO(HeroesStadium entity) {
...
//                .nickname("ADMIN")
    ...
    // Read
    default StadiumDTO entitiesToDTO(HeroesStadium entity, List<HeroesStadiumImage> stadiumImages) {
        StadiumDTO stadiumDTO = StadiumDTO.builder()
                .sno(entity.getSno())
                .base(entity.getBase())
                .section(entity.getSection())
